...
const ChatPage = () => {
    ...
    const sendMessageHandler = async (receiverId) => {
        try {
            const res = await axios.post(`https://insta-clone-6tqn.onrender.com/api/v1/message/send/${receiverId}`, { textMessage }, {
                headers: {
            ...
            </section >
            {
                selectedUser ? (
                    <section className='flex-1 border-1 border-l-gray-300 flex flex-col h-full'>
                        <div className='flex gap-3 items-center px-3 py-2 border-b border-gray-300 stick top-0 bg-white z-10'>
                            <Avatar>
